...
**Full write-up (background, methods, interactive figures, results):**
**https://sncr0.github.io/md-active-learning/** — source in [`docs/index.html`](docs/index.html),
figure data generated by [`scripts/build_figdata.py`](scripts/build_figdata.py).
